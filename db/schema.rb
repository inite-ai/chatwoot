...
ActiveRecord::Schema[7.1].define(version: 2025_08_30_000001) do
  ...
  create_table "channel_telegram_accounts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "last_update_pts"
    t.string "phone_code_hash"
    t.index ["account_id"], name: "index_channel_telegram_accounts_on_account_id"
    t.index ["phone_number", "account_id"], name: "index_channel_telegram_accounts_on_phone_number_and_account_id", unique: true
  end
